                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">506</div>
                                </div>
                                <div class="col">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                Total jubilados ultimo año</div>
...
<script>
    async function actualizarDatosJubilados() {
        try {
            const response = await fetch('http://localhost:3000/jubilados/202308');
            const data = await response.json();
            const cantidadJubilados = data.cantidad;
            ...
            const response2 = await fetch('http://localhost:3000/jubiladas/202308');
            const data2 = await response2.json();
            const cantidadJubiladas = data2.cantidad;
